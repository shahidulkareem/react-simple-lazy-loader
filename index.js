 ...
 */
  ...
  * @returns 
  */
 function reducerInjectors(store, reducers) {
     checkStore(store);
...
function sagaInjectors(store) {
  ...
  * @returns 
  */  
 const simpleLazyLoadedRoute= (store, reducers) => {
 ...
 module.exports = simpleLazyLoadedRoute;
 module.exports.sagaInjectors = sagaInjectors;
